...
<?php
$date = date('d');
$image = 'login_bg_'.$date.'.jpg';
?>
  body{background:url('<?php echo URL::to('assets/images/login_screen').'/'.$image; ?>') no-repeat center top !important; 
...
<body>
<div style="width: 100%; height: auto; text-align: left; float: left; margin-bottom: 20px; padding: 50px 0px 0px 50px; margin-bottom: 10%;"><img src="<?php echo URL::to('assets/images/easy_payroll_logo2.png')?>" ></div>
<div class="login_box">
  <!-- <div class="row">
