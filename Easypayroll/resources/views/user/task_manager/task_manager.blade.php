        ...
        <div class="modal-content">
          ...
          <div class="modal-body" style="min-height: 193px;padding: 5px;">
            ...
            <div class="col-md-12" style="padding: 0px;">
              <div class="existing_comments" id="existing_comments" style="width:100%;background: #c7c7c7;padding:10px;min-height:300px;height:300px;overflow-y: scroll;font-size: 14px"></div>
            </div>
